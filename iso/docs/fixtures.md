...
| D3 | `…\Reinvestigación\Mecanizados\Fresado\` | 155 | el fresado — 🔄 **grupos 1 a 9 cerrados** (147 `.iso` y 14 capturas); **grupos 8 y 9 cerrados** (la matriz 7×7 de fresas, y la cara); grupos 10 a 16 pendientes | `experiments/fresado.md` |
