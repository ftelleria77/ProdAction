...
| **N037** | **Eje B: Canal con la Sierra Vertical X (082)** | **9/9 byte-idéntico a la primera**: header sin ATC (ETK[6]=82, ETK[17]=257, ETK[1]=16, SHF mandril con w/2 restado en Y), sentido NORMALIZADO a −x, ETK[7]=1, transición doble-G0, epílogo con dwell | `_channel.py`, `test_iso_saw_channel.py`, [saw_channel.md](saw_channel.md) |
