...
| **N034** | multipaso + leads: matriz de desambiguación | regla distinta observada (r=w/2, lado espejado); leads se RECALCULAN del spec (rm3 lo prueba) → fixtures sintetizados genuinos — **pendiente de postproceso** | `iso/machining_lab/n034_router_mp_leads` |
