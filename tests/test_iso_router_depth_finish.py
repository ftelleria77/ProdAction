...
_FIXTURE_DIR = Path(r"S:\Maestro\Projects\ProdAction\Investigacion iso_converter\N024_router_through")
_REF_DIR = Path(r"P:\USBMIX\ProdAction\Investigacion iso_converter\N024_router_through")
