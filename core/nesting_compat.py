"""Compatibility contract for the historical ``core.nesting`` module."""
...
PUBLIC_COMPATIBILITY_NAMES = (
    "generate_cut_diagrams",
    "build_cut_diagram_pdf",
    "first_fit_2d",
    "Piece",
    "Project",
    "CutPiece",
...
LAB_COMPATIBILITY_NAMES = (
    ...
    "SectionSelection",
    "_apply_board_margin",
    "_build_main_cut_guides",
    "_build_section_placements",
    "_expand_project_pieces",
    "_normalize_board_definition",
    "_normalize_board_grain_axis",
    "_normalize_optimization_mode",
    "_occupied_span",
    "_order_group_pieces",
    "_pack_group_into_boards",
    "_resolve_board_definition",
    "_section_dimensions",
    "_uses_guillotine_mode",
)
...
LEGACY_COMPATIBILITY_NAMES = (
    ...
    "_board_state_score",
    "_brkga_tail_fitness",
    "_build_en_juego_cut_piece",
    "_build_order_driven_section",
    "_build_section_candidate",
    "_composition_grain_axes",
    "_composition_layout_rect",
    "_composition_layout_rect_from_footprints",
    "_composition_layout_rect_from_scene",
    "_decode_random_key_order",
    "_derived_grain_axis_for_layout",
    "_dimension_scan_state_score",
    "_first_order_section_leader",
    "_full_tail_section_metrics",
    "_has_valid_cut_dimensions",
    "_initial_order_keys",
    "_is_valid_piece",
    "_layout_has_footprint",
    "_layout_piece_id",
    "_layout_rotation_degrees",
    "_legacy_layout_scene_rect",
    "_matching_option_for_order_section",
    "_module_short_name",
    "_mutate_random_keys",
    "_normalize_guillotine_algorithm",
    "_normalize_piece_grain_mode",
    "_orientation_options",
    "_pack_group_into_boards_free_rectangles",
    "_pack_group_into_boards_guillotine",
    "_pack_group_into_boards_guillotine_brkga_tail",
    "_pack_group_into_boards_guillotine_dimension_scan",
    "_pack_group_into_boards_order_driven_guillotine",
    "_piece_can_rotate",
    "_placement_score",
    "_preferred_primary_secondary",
    "_prune_free_rectangles",
    "_read_module_config",
    "_rectangles_intersect",
    "_resolve_cut_piece_dimensions",
    "_resolve_layout_drawing_dimensions",
    "_resolve_piece_source_value",
    "_row_by_piece_id",
    "_safe_float",
    "_safe_quantity",
    "_sanitize_filename",
    "_section_axes_for_mode",
    "_section_build_score",
    "_section_candidate_score",
    "_section_leader_dimensions",
    "_section_selection_sort_key",
    "_section_similarity_metrics",
    "_selection_dimension_rank",
    "_split_free_rectangle",
    "_stored_layout_dimensions",
    "_unique_nonempty_values",
)

__all__ = tuple(
    dict.fromkeys(PUBLIC_COMPATIBILITY_NAMES + LAB_COMPATIBILITY_NAMES + LEGACY_COMPATIBILITY_NAMES)
)
