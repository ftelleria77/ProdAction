...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    line_milling = build_line_spec(
        start_x=args.line_x1,
        start_y=args.line_y1,
        end_x=args.line_x2,
        end_y=args.line_y2,
        feature_name=args.line_feature_name,
        side_of_feature=args.line_side_of_feature,
        tool_id=args.line_tool_id,
        tool_name=args.line_tool_name,
        tool_width=args.line_tool_width,
        security_plane=args.line_security_plane,
        is_through=args.line_through,
        target_depth=args.line_target_depth,
        extra_depth=args.line_extra_depth,
        approach_enabled=args.line_approach_enabled,
        approach_type=args.line_approach_type,
        approach_mode=args.line_approach_mode,
        approach_radius_multiplier=args.line_approach_radius_multiplier,
        approach_speed=args.line_approach_speed,
        approach_arc_side=args.line_approach_arc_side,
        retract_enabled=args.line_retract_enabled,
        retract_type=args.line_retract_type,
        retract_mode=args.line_retract_mode,
        retract_radius_multiplier=args.line_retract_radius_multiplier,
        retract_speed=args.line_retract_speed,
        retract_arc_side=args.line_retract_arc_side,
        retract_overlap=args.line_retract_overlap,
    )
